...
export function MappingHomePageResponseDto(homePage: HomePageWithProfile): GetAllHomePageResponseDto {
    return {
...
export function MappingListHomePageResponseDto(homePage: HomePageWithProfile[]): GetAllHomePageResponseDto[] {
